define(["exports"], function (_exports) {
  ...
  */
  ...
  function (_LitElement) {
    babelHelpers.inherits(InputLitElement, _LitElement);
    babelHelpers.createClass(InputLitElement, null, [{
      key: "properties",
      get: function get() {
        return {
          value: {
    ...
    return InputLitElement;
  }(LitElement);

  _exports.InputLitElement = InputLitElement;
  customElements.define('input-lit-element', InputLitElement);
  var inputLitElement = {
    InputLitElement: InputLitElement
  };
  _exports.$inputLitElement = inputLitElement;
});